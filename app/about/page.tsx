  ...
  return (
    <section className="py-8 max-w-3xl">
      ...
      <div className="text-neutral-700 space-y-4">
        ...
        <p>
          ผมเป็นผู้ชอบถ่ายรูปคนหนึ่ง แแต่ไม่ชอบโดนถ่ายรูป แฮะ ๆ 😅 ผมยังเป็นมือใหม่ในวงการนี้และยังแต่งสีไม่เป็นเลยยย ฮื่อออ 😭 ยังไงก็ขอฝากเนื้อฝากตัวในวงการนี้ด้วยนะครับบบบ 🙏
        </p>
